...
import com.gisele.main.StringGisele;
...
public class ClaseString {
	...
	public static void main(String[] args) {
		...
		String titulo = "Cadenanitas de prueba para cambiar letra";
		...
		//Crear objeto GiseleString
		StringGisele stringGisele = new StringGisele(titulo);
		...
		System.out.println(stringGisele.canbiarLetra(18));
